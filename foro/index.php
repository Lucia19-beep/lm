...
}// Si no hay sesión iniciada, redirige a index.php y, como redirige y aun no se ha creado la sesión, vuelve a redirigir infinitamente y da el error ERR_TOO_MANY_REDIRECTS
...
$query = "SELECT id, titulo, ruta_foto_hilo FROM hilos ORDER BY id DESC LIMIT 10";
